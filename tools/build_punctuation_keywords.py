...
def main() -> None:
    ...
    header = [
        "# Generated by tools/build_punctuation_keywords.py -- do not edit by hand.",
        "#",
        "# Each line is a sequence of model tokens followed by @<id>. English is ARPAbet,",
        "# Chinese is pinyin initial + tone-marked final. The ids are matched in",
        "# app/src/main/java/com/offlinekeyboard/ime/asr/PunctuationCommands.kt.",
    ]
